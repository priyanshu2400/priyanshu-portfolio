...
export default function Footer() {
    return (
        <footer className="py-20 px-6" style={{ background: 'var(--color-surface-deep)' }}>
            <div className="max-w-3xl mx-auto">
                <div className="footer-panel p-8 text-center">
                    <p
                        className="text-sm leading-relaxed mb-6 max-w-md mx-auto"
                        style={{ color: 'var(--color-text-secondary)', textWrap: 'balance' }}
                    >
                        I build systems, break things, and write down what I learn.
                    </p>
